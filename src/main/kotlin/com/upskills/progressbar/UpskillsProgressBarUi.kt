...
class UpskillsProgressBarUi: BasicProgressBarUI() {
    companion object {
        @JvmStatic
        fun createUI(c: JComponent?): UpskillsProgressBarUi {
            c?.border = JBUI.Borders.empty().asUIResource()
            return UpskillsProgressBarUi()
        }
    }
    ...
    override fun paintIndeterminate(g2d: Graphics?, c: JComponent) {
        ...
        val baseRainbowPaint = getWhiteGradientBar()
        ...
        val scaledIcon: Icon = if (velocity > 0) UpskillsIcons.UPS_ICON else (UpskillsIcons.R_UPS_ICON as ScalableIcon)

        scaledIcon.paintIcon(progressBar, g, offset2 - JBUI.scale(10), -JBUI.scale(1))
    ...
    override fun paintDeterminate(g: Graphics, c: JComponent) {
        ...
        UpskillsIcons.UPS_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(1))
        g2.translate(0, -(c.height - h) / 2)
    ...
    private fun getBlueGradientBar() : GradientPaint {
    ...
    private fun getWhiteGradientBar() : GradientPaint {
        return GradientPaint(
            0f,
            JBUI.scale(2).toFloat(),
            Color(161,164,167),
